...
export function generateInitialSessions(_classes?: ClassGroup[], _students?: Student[]): AttendanceSession[] {
  // Return empty array by default so no mock lectures appear as taken until faculty actually marks them
  return [];
}
